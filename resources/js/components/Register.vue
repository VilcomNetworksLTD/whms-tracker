    ...
    <div class="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 flex flex-col items-center justify-center p-4">
                ...
                <div v-if="step === 1">
                    ...
                    <form @submit.prevent="handleRegister" class="space-y-5">
                        ...
                        <div>
                            ...
                            <p class="text-xs text-gray-500 mt-1">Only @vilcom.co.ke email addresses are allowed</p>
                        </div>
        ...
        <div class="mt-6 flex items-center text-sm text-gray-500">
            <svg class="w-4 h-4 mr-2 text-green-500" fill="currentColor" viewBox="0 0 20 20">
                <path fill-rule="evenodd" d="M2.166 4.999A11.954 11.955 0 0010 1.944 11.954 11.955 0 0017.834 5c.11.65.166 1.32.166 2.001 0 5.225-3.34 9.67-8 11.317C5.34 16.67 2 12.225 2 7c0-.682.057-1.35.166-2.001zm11.541 3.708a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd" />
            </svg>
...
export default {
    ...
    methods: {
        async handleRegister() {
            ...
            if (!this.isVilcomEmail(this.form.email)) {
                this.error = "Only @vilcom.co.ke email addresses are allowed";
                return;
            }
        ...
        async handleVerify() {
            ...
            try {
                ...
                if (response.data.success) {
                    ...
                    this.otpError = response.data.message || "Verification failed";
                    this.shakeForm();
                }
            } catch (err) {
                if (err.response && err.response.data) {
        ...
        // Add this method to check Vilcom email
        isVilcomEmail(email) {
            return /^[a-zA-Z0-9._%+-]+@vilcom\.co\.ke$/i.test(email);
        }
    },
    mounted() {
